...
#define STRING_CONFIG_H_AUTHOR "(rs-elec, Ender-3 Pro)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 154.57
  #define DEFAULT_bedKi 30.12
  #define DEFAULT_bedKd 528.73
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.34, 80.51, 400, 147.04 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40.8, -2.7, -1.37 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_HEIGHT      0.31  // (mm) Z height of nozzle at leveling points
